...
stackgres-setup: kind-setup csi-host-path-setup ## Install StackGres
	...
	helm upgrade --version 1.17.0 --install --create-namespace --namespace stackgres stackgres-operator  stackgres-charts/stackgres-operator --values stackgres/values.yaml --wait
